  ...
  return (
    <Container>
      ...
      <form onSubmit={submittedForm} action="">
        ...
        <select onChange={event=>handleCardPayment(event.target.value)}  required name="" id="">
...
<p>Növbəti 10 gün ərzində məlumat bölgəsində verilən addresə yaxınlaşaraq nömrənizi əldə edə bilərsiniz.
    Əks təqdirdə 10 gün sonra nömrə ləğv olunub yenidən satışa çıxarılacaqdır.
</p>
<Link className="backLink" to={"/"}>Ana səfihəyə dön</Link>
</div>
      )
      }
    </Container>
